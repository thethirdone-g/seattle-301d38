...
// Whenever a 'this' is used in an arrow function the computer will look up the scope to see if it can find the value of 'this'. It'll start first with the object and see that there is no 'this' and then it will bubble up to global scope and it won't find anything there either.
